    ...
    <div className="flex border-b border-gray-100" style={{ gap: '1.2vw', padding: '1vw 0' }}>
      ...
      <div className="flex-1 flex flex-col justify-center">
        <Link href={`/insights/${article.id}`} className="no-underline text-inherit">
          <h3 className="font-semibold text-gray-900 leading-snug hover:text-[#00A4E4] transition-colors" style={{ fontSize: '0.95vw', marginBottom: '0.3vw' }}>
            {article.title}
          </h3>
        </Link>
        <p className="text-gray-500 leading-relaxed line-clamp-2" style={{ fontSize: '0.7vw', marginBottom: '0.6vw' }}>
          {article.description}
        </p>
        <div className="flex justify-between items-center">
          <div className="text-gray-400 flex items-center" style={{ fontSize: '0.6vw', gap: '0.3vw' }}>
